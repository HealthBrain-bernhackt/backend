...
from .models import Treatment, Message, Profile, Diagnosis
...
class CreateMessageView(generics.CreateAPIView):
    ...
    def create(self, request, *args, **kwargs):
        ...
        send_mail(subject, message_content, from_email, recipient_list, fail_silently=False, html_message=message_content)
